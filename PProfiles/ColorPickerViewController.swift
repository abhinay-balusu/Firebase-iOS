...
//  PProfiles
//
//  Created by Abhinay Balusu on 11/6/16.
...
class ColorPickerViewController: UIViewController, UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {
    ...
    override func viewDidLoad() {
        ...
        self.colorCollectionView.registerNib(UINib(nibName: "ColorCollectionViewCell", bundle: nil), forCellWithReuseIdentifier: "ColorCell")
        //self.view.addSubview(collectionView)
        self.colorCollectionView.decelerationRate = UIScrollViewDecelerationRateFast
    ...
    internal func convertHexToUIColor(hexColor hexColor : String) -> UIColor {
