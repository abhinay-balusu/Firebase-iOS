...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    var window: UIWindow?
    var profilesListViewController = ProfilesListViewController()
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        ...
        navController = UINavigationController(rootViewController: profilesListViewController)
        ...
        TestFairy.begin("ad4f6947540ba3705a47f323ae7d305ae632ae97")
